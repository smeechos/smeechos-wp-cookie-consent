...
//        esc_html_e( 'Options for the modal.', 'wpcookieconsent' );
    ...
    public function wpcookieconsent_modal_background_color_display() {
        ...
        if ( isset( $this->options['background_colo'] ) ) {
            $color = esc_html( $this->options['background_colo'] );
        }

        echo '<input type="text" name="wpcookieconsent_settings[background_colo]" value="' . $color . '" class="color-field" >';
    }
